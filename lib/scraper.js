...
function flutter(packageName) {
    const link = "https://pub.dev/documentation/" + packageName + '/latest/'
    return new Promise((resolve, reject) => {
...
module.exports = { pinterest, wallpaper, wikimedia, quotesAnime, aiovideodl, umma, ringtone, styletext, flutter }
